...
export default function AssociatedWithSection() {
  ...
  return (
    <section id="associated-with-section" className="relative z-10 w-full pt-8 pb-24 bg-transparent">
        ...
        >
          {associations.map((item) => (
            <motion.div
              ...
              whileHover={{ y: -4 }}
              className="group relative h-56 md:h-72 rounded-3xl border border-white/10 bg-white/[0.03] backdrop-blur-2xl overflow-hidden flex flex-col items-center justify-center p-8 transition-all duration-500 shadow-[0_8px_32px_rgba(0,0,0,0.5)] hover:bg-white/[0.06] hover:border-white/20"
            >
              ...
              <div className="relative mb-6">
                ...
                <div className="relative w-16 h-16 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md flex items-center justify-center shadow-[inset_0_0_15px_rgba(255,255,255,0.05)] transition-colors duration-500">
                   <item.icon className="w-8 h-8 text-white/70 group-hover:text-white transition-colors duration-500 drop-shadow-[0_0_8px_rgba(255,255,255,0.1)]" />
                </div>
              </div>
              
              <h3 className="text-xl md:text-2xl font-bold text-white/90 group-hover:text-white mb-2 transition-colors duration-300 relative z-10 text-center tracking-tight">{item.name}</h3>
