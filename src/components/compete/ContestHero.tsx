  ...
  return (
    <section
      className={cn(
        ...
        isLive
          ? 'border-green-500/30 spotlight-success'
    ...
    >
      <div
        aria-hidden="true"
        className={cn(
          'pointer-events-none absolute -top-28 -right-20 h-72 w-72 rounded-full blur-3xl light:hidden',
      ...
      <div className="relative flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between lg:gap-8">
        <div className="min-w-0">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[10px] font-bold text-body uppercase tracking-wider px-2 py-0.5 rounded-full bg-raised border border-line-strong">
              {contest.difficulty}
            </span>
          </div>

          <h2 className="text-xl sm:text-2xl font-bold text-strong tracking-tight leading-snug">
            {contest.title}
          </h2>
          <p className="text-sm text-subtle mt-1.5 line-clamp-2 max-w-2xl">{contest.description}</p>

          <div className="flex flex-wrap items-center gap-x-5 gap-y-2 mt-4 text-xs text-subtle font-medium">
        ...
        <div className="shrink-0 lg:text-right">
          <p className="text-[10px] font-bold uppercase tracking-[0.14em] text-faint mb-1.5">
          ...
          <p className="text-[11px] text-faint mt-1.5">{formatDateTime(contest.startTime)}</p>
          ...
          <Link
            ...
            className={cn(
              ...
              isLive
                ...
                : 'bg-accent text-on-accent hover:bg-accent/90 shadow-[0_0_20px_rgba(34,211,238,0.25)]'
            )}
          >
