...
export function IDELinkBanner() {
  ...
  return (
    <Link
      ...
      className="group block w-full bg-[#0B1121] hover:bg-[#111827] border border-white/5 rounded-2xl p-4 transition-all duration-300 shadow-lg relative overflow-hidden"
    >
      <div className="flex items-center gap-4 relative z-10">
        ...
        <div className="flex flex-col flex-1">
          <h3 className="text-base font-bold text-white tracking-tight mb-0.5">Open the IDE</h3>
        ...
        <div className="text-slate-500 group-hover:text-white transition-colors flex-shrink-0 pr-2">
