export type ContentBlock =
  ...
  | { type: 'challenge_list'; challenges: { id: string; title: string; difficulty: string; status: string }[] }
          ...
          "content": [
            ...
            },
            {
              ...
              "rows": [
                [
                  ...
                  "The stove, oven, and knives (the core tool)"
                ],
                [
                  "Virtual environment (venv)",
                  "Your private kitchen counter (isolated workspace)"
                ],
                [
                  "pip",
                  "The grocery delivery service (installs packages)"
                ],
                [
                  "Packages (requests, pandas)",
                  "Fresh ingredients (third-party libraries)"
                ],
                [
                  "requirements.txt",
                  "The exact shopping list (reproducible environment)"
                ],
                [
                  "IDE (VS Code / PyCharm)",
                  "Beautifully organised kitchen drawers (code editor)"
                ],
                [
                  ".gitignore (venv excluded)",
                  "Keeping your mess off the shared recipe book (GitHub)"
                ]
              ]
            },
            {
            ...
            },
            {
              ...
              "rows": [
                [
                  "Python 3.11+",
                  "The interpreter that runs your code",
                  "The stove",
                  "Always \u2014 it IS Python"
                ],
                [
                ...
                [
                  ...
                  "Shopping list",
                  "Sharing and deploying projects"
                ],
                [
                  "VS Code / PyCharm",
                ...
                [
                  ...
                  "The pass where orders come in",
                  "All pip and venv commands"
                ]
              ]
            },
            {
            ...
            {
              "type": "paragraph",
              "html": "<em>Run <code>python --version</code> in your terminal right now. If it shows 3.11 or higher, great. If you see 2.7 or nothing, do not worry \u2014 Lesson 3 covers the exact installation steps for Windows, macOS, and Linux.</em>"
            },
            {
              "type": "heading",
              "level": 2,
              "text": "Your Learning Path for Today"
            },
            {
              "type": "list",
              "format": "number",
          ...
          "content": [
            {
              "type": "heading",
              "level": 1,
              "text": "Installing Python 3.11+: The Foundation of Everything"
            },
            {
              "type": "heading",
              "level": 2,
              "text": "Installation Guide \u2013 All Platforms"
            },
            {
              "type": "code",
              "language": "bash",
          ...
          "content": [
            {
              "type": "heading",
              "level": 1,
              "text": "Choosing the Right IDE: VS Code, PyCharm, and Jupyter"
            },
            {
              "type": "heading",
              "level": 2,
              "text": "IDE Comparison \u2013 Which One Is Right for You?"
            },
            {
              "type": "table",
              "headers": [
              ...
              "rows": [
                [
                  "VS Code",
                  "General Python, web, beginners",
                  "Free",
                  "Python extension, debugger, Git, terminal, lightweight"
                ],
                [
                  "PyCharm Community",
                  "Pure Python projects",
                  "Free",
                  "Best Python autocomplete, built-in venv, refactoring"
                ],
                [
                  "PyCharm Professional",
                  "Django, Flask, databases",
                  "Paid (~$99/yr)",
                  "Web frameworks, SQL, Django ORM support, profiler"
                ],
                [
                  "Jupyter Notebook",
                  "Data science, ML, exploration",
                  "Free",
                  "Cell-by-cell execution, plots inline, markdown"
                ],
                [
                  "Jupyter Lab",
                  "Data science (advanced)",
                  "Free",
                  "Multi-panel, better UI than Notebook, extensions"
                ],
                [
                  "Thonny",
                  "Absolute beginners (kids)",
                  "Free",
                  "Step-by-step debugger, extremely simple UI"
                ]
              ]
            },
            {
          ...
          "content": [
            {
              "type": "heading",
              "level": 1,
              "text": "pip: Your Python Package Manager"
            },
            {
              "type": "heading",
              "level": 2,
              "text": "pip \u2013 Complete Command Reference"
            },
            {
              "type": "code",
              "language": "bash",
            ...
            },
            {
              "type": "heading",
              "level": 2,
              "text": "Popular Python Packages \u2013 Your First Pantry"
            },
            {
              "type": "table",
              "headers": [
          ...
          "content": [
            {
              "type": "heading",
              "level": 1,
              "text": "Python Environment Best Practices: What Every Professional Developer Does"
            },
            {
              "type": "heading",
              "level": 2,
              "text": "The 8 Professional Rules"
            },
            {
              "type": "list",
              "format": "number",
          ...
          "content": [
            {
              "type": "heading",
              "level": 1,
              "text": "Hands-On Exercise: Create a Virtual Environment and Install External Packages"
            },
            {
              "type": "heading",
              "level": 2,
              "text": "Complete Hands-On \u2013 Build a Real Python Project Environment"
            },
            {
              "type": "heading",
              "level": 3,
            ...
            },
            {
              "type": "code",
              "language": "bash",
              "code": "mkdir my_first_project\ncd my_first_project"
            },
            {
              "type": "heading",
              "level": 3,
              "text": "Step 2: Create the Virtual Environment"
            },
            {
              "type": "code",
              "language": "bash",
              "code": "python -m venv venv        # creates isolated Python environment\n# Windows: python -m venv venv\n# Mac/Linux: python3 -m venv venv"
            },
            {
              "type": "heading",
              "level": 3,
              "text": "Step 3: Activate It"
            },
            {
              "type": "code",
              "language": "bash",
            ...
            },
            {
              "type": "heading",
              "level": 3,
              "text": "Step 5: Install Packages"
            },
            {
              "type": "code",
              "language": "bash",
              "code": "pip install requests         # HTTP library\npip install pandas           # data analysis\npip install python-dotenv    # load .env files"
            },
            {
              "type": "heading",
              "level": 3,
              "text": "Step 6: Verify Installation"
            },
            {
              "type": "code",
              "language": "bash",
            ...
            },
            {
              "type": "heading",
              "level": 3,
              "text": "Step 7: Create Project Structure"
            },
            {
              "type": "code",
              "language": "bash",
              "code": "# Create the main Python file:\ntouch main.py          # (Mac/Linux)\ntype nul > main.py     # (Windows)"
            },
            {
              "type": "heading",
              "level": 3,
              "text": "Step 8: Set Up .gitignore"
            },
            {
              "type": "code",
              "language": "bash",
            ...
            },
            {
              "type": "heading",
              "level": 3,
              "text": "Step 9: Generate requirements.txt"
            },
            {
              "type": "code",
              "language": "bash",
          ...
          "content": [
            ...
            },
            {
              ...
              "rows": [
                [
                  "1",
                  "Installing packages globally (no venv)",
                  "Always create and activate venv first, then pip install"
                ],
                [
                  "2",
                  "Committing venv/ folder to Git (100MB+)",
                  "Add venv/ to .gitignore, use requirements.txt instead"
                ],
                [
                  "3",
                  "Using python 2.7 unintentionally",
                  "Run `python --version`; use `python3` on Mac/Linux"
                ],
                [
                  "4",
                  "Hardcoding API keys in Python files",
                  "Use .env file + python-dotenv, add .env to .gitignore"
                ],
                [
                  "5",
                  "Forgetting to activate venv (packages not found)",
                  "Check prompt for (venv) prefix; run `source venv/bin/activate`"
                ],
                [
                  "6",
                  "requirements.txt with no version pins",
                  "Use `pip freeze > requirements.txt` for exact versions"
                ],
                [
                  "7",
                  "One venv for all projects (defeats the purpose)",
                  "Create a separate venv in every project folder"
                ],
                [
                  "8",
                  "Outdated pip causing install failures",
                  "Run `python -m pip install --upgrade pip` regularly"
                ]
              ]
            }
          ]
          ...
          "content": [
            {
              "type": "heading",
              "level": 1,
              "text": "Final Challenge + Complete Cheat Sheet & Expert Summary"
            },
            {
              "type": "heading",
              "level": 2,
              "text": "Final Challenge \u2013 Complete Professional Python Setup"
            },
            {
              "type": "list",
              "format": "bullet",
            ...
            },
            {
              ...
              "rows": [
                [
                  ...
                  "venv not activated; run `source venv/bin/activate` then `pip install requests`"
                ],
                [
                  "2",
                  "`python: command not found`",
                  "Python not in PATH; re-install with \"Add to PATH\" checked, or use `python3`"
                ],
                [
                  "3",
                  "`pip: command not found`",
                  "Use `python -m pip install ...` instead; or `pip3` on Mac/Linux"
                ],
                [
                  "4",
                  "venv creation fails: `ensurepip is not available`",
                  "Install python3-venv: `sudo apt install python3.11-venv` (Ubuntu)"
                ],
                [
                  "5",
                ...
                [
                  "6",
                  "Wrong Python version runs despite installing 3.11",
                  "Multiple Python versions on PATH; use pyenv or specify full path"
                ],
                [
                  "7",
                  "requirements.txt installs wrong versions",
                  "Use `pip freeze` (exact `==`) not `pip list` (no versions)"
                ],
                [
                  "8",
                  "`ImportError: cannot import name X from package Y`",
                  "Wrong package version; check requirements.txt and pin exact version"
                ]
              ]
            },
            {
              "type": "heading",
              "level": 2,
              "text": "Production Checklist \u2013 You Are Now a Python Environment Expert"
            },
            {
              "type": "list",
              "format": "bullet",
