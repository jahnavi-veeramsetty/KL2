          ...
          <div className="relative p-6 md:p-8 rounded-[2rem] bg-[#000918]/60 backdrop-blur-[40px] shadow-[0_16px_40px_rgba(0,0,0,0.8)] border border-white/[0.08] overflow-hidden group/card transition-all duration-700 hover:shadow-[0_20px_64px_rgba(255,253,240,0.1)] hover:border-white/[0.12] hover:bg-[#000918]/70">
            ...
            <form onSubmit={handleLogin} className="relative z-10 space-y-5">
              <div className="space-y-1.5">
                <label className="block text-xs font-medium text-brand-neutral/70 ml-1" htmlFor="login-id">
                  User ID
                </label>
                <div className="relative group/input">
                  ...
                  <input
                    ...
                    className="relative w-full bg-[#00040a]/80 border border-white/[0.1] rounded-2xl px-4 py-3 text-sm text-white placeholder-white/30 focus:outline-none focus:border-white/30 focus:bg-[#00040a] transition-all duration-300 backdrop-blur-md shadow-inner"
                    required
                  />
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                <label className="block text-xs font-medium text-brand-neutral/70 ml-1" htmlFor="login-password">
                  Password
                </label>
                <div className="relative group/input">
                  <div className="absolute -inset-0.5 bg-gradient-to-r from-[#466eff]/40 to-brand-tertiary/40 rounded-2xl blur opacity-0 group-focus-within/input:opacity-100 transition duration-500" />
            ...
            <div className="relative z-10 mt-6 text-center text-xs text-brand-neutral/50">
              ...
              <Link to="/?auth=signup" className="text-white hover:text-white transition-colors hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.5)] font-medium">
                Sign up
              </Link>
            </div>
          </div>
